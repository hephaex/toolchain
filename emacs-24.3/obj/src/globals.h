...
#define Vlucid_menu_bar_dirty_flag globals.f_Vlucid_menu_bar_dirty_flag
  Lisp_Object f_Vmac_in_echo_area;
#define Vmac_in_echo_area globals.f_Vmac_in_echo_area
  Lisp_Object f_Vmac_use_input_method_on_system;
#define Vmac_use_input_method_on_system globals.f_Vmac_use_input_method_on_system
...
#define Vnobreak_char_display globals.f_Vnobreak_char_display
  Lisp_Object f_Vns_alternate_key_mask;
#define Vns_alternate_key_mask globals.f_Vns_alternate_key_mask
  Lisp_Object f_Vns_command_key_mask;
#define Vns_command_key_mask globals.f_Vns_command_key_mask
  Lisp_Object f_Vns_control_key_mask;
#define Vns_control_key_mask globals.f_Vns_control_key_mask
...
#define Vns_sent_selection_hooks globals.f_Vns_sent_selection_hooks
  Lisp_Object f_Vns_shift_key_mask;
#define Vns_shift_key_mask globals.f_Vns_shift_key_mask
...
EXFUN (Flsh, 2);
EXFUN (Flss, 2);
EXFUN (Fmac_get_current_input_source, 0);
EXFUN (Fmac_get_input_source_list, 0);
EXFUN (Fmac_input_source_is_ascii_capable, 0);
EXFUN (Fmac_toggle_input_source, 1);
